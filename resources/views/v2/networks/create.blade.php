                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                {!! Form::text('callback_url', null, ['id' => 'callback_url', 'class' => 'form-control', 'placeholder' => 'Callback Url', 'required' => 'required']) !!}
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                {!! Form::text('callback_allow_ip', null, ['id' => 'callback_allow_ip', 'class' => 'form-control', 'placeholder' => 'Callback Allow Ips']) !!}
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                {!! Form::text('cron_url', null, ['id' => 'cron_url', 'class' => 'form-control', 'placeholder' => 'Cron Url']) !!}
                            </div>
                        </div>
